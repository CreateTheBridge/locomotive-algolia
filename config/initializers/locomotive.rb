Locomotive.configure do |config|
  ...
  if Rails.env.production? and !ENV['SITE_HOST'].blank? 
    config.host = ENV['SITE_HOST']
  end
  ...
  config.enable_logs = !Rails.env.production?
  ...
  config.mailer_sender = Rails.application.secrets[:mail][:default_from] 
  ...
  config.steam_image_resizer_secret = if Rails.env.production? 
    ENV['SECRET_KEY_BASE']
  else 
    'fe9b5529532e9f57b64902c375abdaff132404652bde6b3a64a1b43cfd18d561bd44d7d009ea678a514b8975d71eeb4ae06c2f7f670cbeba4884dc9750df2fac'
  end
